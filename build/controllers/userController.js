...
var handleLoginApi = /*#__PURE__*/function () {
  ...
  return function handleLoginApi(_x, _x2) {
...
var handleEditSummaryUser = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          data = req.body;
          _context4.next = 3;
          return _userService["default"].editSummaryUser(data);
        case 3:
  ...
  return function handleEditSummaryUser(_x7, _x8) {
    ...
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
          ...
          // }, 5000)
          typeInput = req.query.type; //ex: http://localhost:8080/allcode?type=status
          _context7.next = 4;
          return _userService["default"].getAllCodeService(typeInput);
        case 4:
          data = _context7.sent;
...
module.exports = {
  ...
  handleEditSummaryUser: handleEditSummaryUser,
