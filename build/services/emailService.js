      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return transporter.sendMail({
            from: "\"EDT\" <".concat(process.env.EMAIL_APP, ">"),
            // sender address
            to: dataSend.receiveEmail,
            // list of receivers
            subject: dataSend.language === 'vi' ? "Test Xác nhận đặt lịch khám bệnh" : "Exam booking confirmation",
            // Subject line
...
var getBodyHTMLEmail = function getBodyHTMLEmail(dataSend) {
  ...
  if (dataSend.language === 'vi') {
    result = "\n            <h3> Ch\xE0o ".concat(dataSend.patientName, "</h3>\n            <p>B\u1EA1n nh\u1EADn \u0111\u01B0\u1EE3c email n\xE0y v\xEC .....</p>\n            <p>Th\xF4ng tin \u0111\u1EB7t l\u1ECBch nh\u01B0 sau:</p>\n            <div><b>Th\u1EDDi gian: ").concat(dataSend.time, "</b></div>\n            <div><b>B\xE1c s\u0129: ").concat(dataSend.doctorName, " </b></div>\n            <p>N\u1EBFu c\xE1c th\xF4ng tin tr\xEAn l\xE0 \u0111\xFAng, vui l\xF2ng click v\xE0o \u0111\u01B0\u1EDDng link\n            b\xEAn d\u01B0\u1EDBi \u0111\u1EC3 x\xE1c nh\u1EADn.</p>\n            <div><a href=").concat(dataSend.directLink, " target='_blank'>Click here</a></div>\n            <p>Xin ch\xE2n th\xE0nh c\u1EA3m \u01A1n.</p>\n        ");
      ...
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return transporter.sendMail({
            ...
            to: dataSend.email,
            // list of receivers
            subject: dataSend.language === 'vi' ? "K\u1EBFt qu\u1EA3 kh\xE1m b\u1EC7nh ".concat(dataSend.patientName) : "Exam Feedback ".concat(dataSend.patientName),
            // Subject line
            html: getBodyHTMLEmailRemedy(dataSend),
            attachments: [{
              // encoded string as an attachment
              filename: "remedy-".concat(dataSend.patientId, "-").concat(new Date().getTime(), ".png"),
              //file name must to '.png'
...
var getBodyHTMLEmailRemedy = function getBodyHTMLEmailRemedy(dataSend) {
  var result = '';
  if (dataSend.language === 'vi') {
    result = "\n            <h3> Ch\xE0o ".concat(dataSend.patientName, "</h3>\n            <p>B\u1EA1n nh\u1EADn \u0111\u01B0\u1EE3c email n\xE0y v\xEC .....</p>\n            <p>Th\xF4ng tin ho\xE1 \u0111\u01A1n \u0111\u01B0\u1EE3c g\u1EDFi trong file \u0111\xEDnh k\xE8m</p>\n            <p>Xin ch\xE2n th\xE0nh c\u1EA3m \u01A1n.</p>\n        ");
  } else if (dataSend.language === 'en') {
