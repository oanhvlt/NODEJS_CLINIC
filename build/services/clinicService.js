...
var saveClinic = function saveClinic(inputData) {
    ...
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(resolve, reject) {
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            if (!(!inputData.name || !inputData.address || !inputData.imageBase64 || !inputData.contentMarkdown || !inputData.contentHTML)) {
              _context.next = 5;
              break;
            }
            resolve({
...
//getClinicById
var getClinicDetailsById = function getClinicDetailsById(id) {
  return new Promise( /*#__PURE__*/function () {
...
module.exports = {
  ...
  getClinicDetailsById: getClinicDetailsById
};