...
var ACTIONS_CREATE = 'CREATE';
var ACTIONS_EDIT = 'EDIT';
var getTopDoctorsHome = function getTopDoctorsHome(limitInput) {
...
var checkRequiredFields = function checkRequiredFields(inputData) {
  var keyArr = ['doctorId', 'contentHTML', 'contentMarkdown', 'action', 'selectedPrice', 'selectedPayment', 'selectedProvince', 'nameClinic', 'addressClinic', 'specialtyId'];
  var isValid = true,
    elem = '';
...
var saveDoctorDetails = function saveDoctorDetails(inputData) {
  return new Promise( /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            ...
            resolve({
              errCode: 1,
              errMessage: "Missing parameter ".concat(checkObj.elem, ".")
            });
            _context3.next = 41;
            break;
          case 6:
          ...
          case 9:
            ...
            break;
          case 11:
            if (!(inputData.action === ACTIONS_EDIT)) {
              _context3.next = 21;
              break;
            }
            _context3.next = 14;
...
var getDoctorDetailsById = function getDoctorDetailsById(inputId) {
  return new Promise( /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          case 0:
            ...
            break;
          case 5:
            schedule = inputData.arrSchedule; //console.log('data send: ', typeof schedule)
...
var getScheduleByDate = function getScheduleByDate(doctorIdInput, dateInput) {
  return new Promise( /*#__PURE__*/function () {
...
var getExtraInfoDoctorById = function getExtraInfoDoctorById(doctorIdInput) {
  return new Promise( /*#__PURE__*/function () {
...
var getProfileDoctorById = function getProfileDoctorById(doctorIdInput) {
  return new Promise( /*#__PURE__*/function () {
