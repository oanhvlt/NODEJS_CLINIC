...
var bookAppointment = function bookAppointment(inputData) {
    ...
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(resolve, reject) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            if (!(!inputData.email || !inputData.fullName || !inputData.address || !inputData.selectedGender || !inputData.doctorId || !inputData.date || !inputData.timeType)) {
              _context.next = 5;
              break;
            }
            resolve({
...
var verifyBookAppointment = function verifyBookAppointment(inputData) {
  return new Promise( /*#__PURE__*/function () {
